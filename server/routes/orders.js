...
const {placeOrder, getUserOrders, placeOrderAfterPayment} = require('../controllers/orderController');
...
router.post('/place', auth.isAuthenticatedUser, placeOrderAfterPayment);
